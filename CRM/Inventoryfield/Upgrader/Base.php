 ...
 */
class CRM_Inventoryfield_Upgrader_Base {

  /**
   * @var CRM_Inventoryfield_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Inventoryfield_Upgrader(
        'com.joineryhq.inventoryfield',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Inventoryfield_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Inventoryfield_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
